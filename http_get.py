...
if __name__ == "__main__":
    ...
    # http_gets('http://detectportal.firefox.com/', 50 )
    # http_gets('http://192.168.178.1/', 1) # router login page
    # http_get.http_gets('http://ftp.snt.utwente.nl/pub/docs/rfc/rfc1498.json',1) # 1000 B
    # http_get.http_gets('http://ftp.snt.utwente.nl/pub/docs/rfc/rfc1535.html') #   10 KiB
    # http_get.http_gets('http://ftp.snt.utwente.nl/pub/docs/rfc/rfc753.html')  #  100 KiB
    # http_gets('http://ftp.snt.utwente.nl/pub/test/1M')               #  977 KiB
